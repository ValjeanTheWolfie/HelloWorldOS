...
SECTION LOADER vstart=BASE_ADDRESS_GDT
    ...
    GDT_ENTRY(0, 0, 0, 0) 
    ; 1 - The loader segment
    GDT_ENTRY(BASE_ADDRESS_LOADER, LIMIT_LOADER, GDT_ACCESS_BYTE_CODE, GDT_FLAGS_4K_32)
    ; 2 - The kernel segment
    GDT_ENTRY(BASE_ADDRESS_KERNEL, LIMIT_KERNEL, GDT_ACCESS_BYTE_CODE, GDT_FLAGS_4K_32)
    ; 3 - The stack segment
